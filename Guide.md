...
cd ~/Developer/mcp-portfolio-tracker
	...
	2.	Generate your asset files inside this folder:
...
You must install the high-level FastMCP server framework along with the Yahoo Finance client data scraper.
